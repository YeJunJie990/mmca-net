...
class GGNN(nn.Module):
    ...
    def forward(self, rel_inds, ent_cls_logits, obj_fmaps, vr):
        ...
        for t in range(self.time_step_num):
            ...
            nodes_img_ent_with_knowledge = nodes_img_ent + message_fusing_img_ent
            nodes_img_pred_with_knowledge = nodes_img_pred + message_fusing_img_pred
            nodes_ont_ent_with_imgfeature = nodes_ont_ent + message_fusing_ont_ent
            nodes_ont_pred_with_imgfeature = nodes_ont_pred + message_fusing_ont_pred

            ####删掉了常识图之间entities和predicate之间的联�?            
