...
# In[5]:
#exp_name = 'whole_CGA_mhop'
exp_name = 'ablation_CGA'
...
-ckpt checkpoints/kern_predcls/{exp_name}/vgrel-10.tar
-val_size 5000 
-adam 
-b 4
-ngpu 1
...
detector = KERN(classes=train.ind_to_classes, rel_classes=train.ind_to_predicates,
                ...
                graph_path=os.path.join(codebase, 'graphs/005/internal_knowledge.pkl'),
